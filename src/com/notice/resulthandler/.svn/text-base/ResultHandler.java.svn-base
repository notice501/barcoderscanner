...
import com.notice.qrcode.Contents;
import com.notice.qrcode.LocaleManager;
import com.notice.qrcode.PreferencesActivity;
...
public abstract class ResultHandler {
   ...
   */
	...
	// }
  void showButton(View.OnClickListener listener) {
	  View shopDangButton = activity.findViewById(R.id.bt_dangdang);
	  shopDangButton.setVisibility(View.VISIBLE);
	  shopDangButton.setOnClickListener(listener);
	  
//	  View shopjingButton = activity.findViewById(R.id.bt_360buy);
//	  shopjingButton.setVisibility(View.VISIBLE);
//	  shopjingButton.setOnClickListener(listener);
	  
	  View shoptaoButton = activity.findViewById(R.id.bt_taobao);
	  shoptaoButton.setVisibility(View.VISIBLE);
	  shoptaoButton.setOnClickListener(listener);
	  
	  View shopyitaoButton = activity.findViewById(R.id.bt_yitao);
	  shopyitaoButton.setVisibility(View.VISIBLE);
	  shopyitaoButton.setOnClickListener(listener);
	  
	  View toogle = activity.findViewById(R.id.tb_lianxu);
