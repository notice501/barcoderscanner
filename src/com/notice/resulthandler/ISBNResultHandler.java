...
import com.notice.qrcode.WebViewActivity;
...
public final class ISBNResultHandler extends ResultHandler {
  ...
  public ISBNResultHandler(final Activity activity, ParsedResult result, Result rawResult) {
    super(activity, result, rawResult);
		...
		// }
		// });
	showButton(new View.OnClickListener() {
...
//				intent.putExtra("value", isbnResult.getISBN());
//				launchIntent(intent);
//				break;
			case R.id.bt_dangdang:
				intent.putExtra("type", "dang");
				intent.putExtra("value", isbnResult.getISBN());
				launchIntent(intent);
				break;
			case R.id.bt_taobao:
